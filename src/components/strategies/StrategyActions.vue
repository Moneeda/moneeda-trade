...
<template>
  <div class="bg-white box-shadow p-4 flex flex-col items-start justify-start">
    ...
    <h3 class="mt-4">{{ $t("playgroundActions") }}</h3>
    ...
    <h3 class="mt-4">{{ $t("playgroundSimulation") }}</h3>
    <el-select
    ...
    <el-button :icon="Select" class="w-full mt-8" plain>{{ $t("playgroundSave") }}</el-button>
    <el-checkbox
      v-model="autosave"
